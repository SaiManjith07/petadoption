    ...
    <div className={`relative flex items-center ${className}`}>
      ...
      <div className={`relative ${currentSize.icon} flex-shrink-0 flex items-center justify-center`}>
        {useImageLogo ? (
          ...
          >
            {/* Heart Shape - Outlined and Filled with Teal */}
            <path
            ...
            {/* Cat Silhouette (Left) - Teal colored, facing right */}
            <g transform="translate(40, 50)">
              {/* Cat Head */}
              <ellipse cx="20" cy="20" rx="15" ry="15" fill="#2BB6AF" />
              {/* Cat Ears */}
              <path d="M10 10 L20 5 L30 10" fill="#2BB6AF" />
              <path d="M10 10 L20 5 L30 10" stroke="#2BB6AF" strokeWidth="2" />
              {/* Cat Body */}
              <ellipse cx="20" cy="45" rx="12" ry="18" fill="#2BB6AF" />
              {/* Cat Tail */}
              <path d="M8 45 Q0 40 0 35 Q0 30 5 28" stroke="#2BB6AF" strokeWidth="3" fill="none" />
            </g>
            
            {/* Dog Silhouette (Right) - Teal colored, facing left */}
            <g transform="translate(110, 50)">
              {/* Dog Head */}
              <ellipse cx="20" cy="20" rx="15" ry="15" fill="#2BB6AF" />
              {/* Dog Ears (floppy) */}
              <ellipse cx="10" cy="25" rx="5" ry="10" fill="#2BB6AF" />
              <ellipse cx="30" cy="25" rx="5" ry="10" fill="#2BB6AF" />
              {/* Dog Body */}
              <ellipse cx="20" cy="45" rx="12" ry="18" fill="#2BB6AF" />
              {/* Dog Tail */}
              <path d="M32 45 Q40 40 40 35 Q40 30 35 28" stroke="#2BB6AF" strokeWidth="3" fill="none" />
            </g>
            
            {/* Location Pin at bottom center - Teal colored */}
            <g transform="translate(85, 140)">
              <circle cx="15" cy="12" r="8" fill="#2BB6AF" />
              <path d="M15 20 L15 35 L10 42 L20 42 L15 35 Z" fill="#2BB6AF" />
            </g>
          </svg>
        )}
      </div>
