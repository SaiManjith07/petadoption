...
const MatchPreview = ({ matches, onClose }: { matches: any[]; onClose: () => void }) => (
  <Card>
    <CardHeader>
      ...
      <CardDescription>These found animals might be yours</CardDescription>
    </CardHeader>
    <CardContent>
...
const LostPetForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      submitFormData.append('report_type', 'lost');
      ...
      if (!response.ok) {
        ...
        toast({
          title: 'Error',
          description: data.message || 'Failed to submit lost pet report',
          variant: 'destructive',
        });
        return;
      }
      ...
      toast({
        title: 'Success!',
        description: 'Your lost pet report has been submitted. Our team will review it shortly.',
      });
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900">Report a Lost Pet</h1>
          <p className="mt-2 text-gray-600">Help us reunite you with your beloved companion. Provide detailed information and photos.</p>
        </div>
        ...
        {showMatches && matches.length > 0 && (
          <Alert className="mb-6 border-orange-200 bg-orange-50">
            ...
            <AlertDescription className="text-orange-900">
              We found {matches.length} potential match{matches.length !== 1 ? 'es' : ''}! Check below to see if any could be your pet.
            </AlertDescription>
          </Alert>
        )}
        ...
        <form onSubmit={handleSubmit}>
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="pet-info">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Tell us about your pet's species and characteristics</CardDescription>
                </CardHeader>
            ...
            <TabsContent value="physical">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Detailed appearance helps us find matches</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <ColorInput
                  ...
                  <NotesInput
                    ...
                    placeholder="e.g., friendly, shy, limping, injured"
                  />
                  ...
                  <NotesInput
                    ...
                    placeholder="e.g., takes medication, has allergy"
                  />
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="location">
              <Card>
                <CardHeader>
                  <CardTitle>When & Where Lost</CardTitle>
                  <CardDescription>Timing and location help us find your pet</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <DateTimeInput
        ...
        {showMatches && matches.length > 0 && (
          <div className="mt-12">
            <MatchPreview matches={matches} petType="found" onClose={() => setShowMatches(false)} />
          </div>
        )}
      </div>
    </div>
