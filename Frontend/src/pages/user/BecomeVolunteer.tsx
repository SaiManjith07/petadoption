  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-green-50/30 flex items-center justify-center p-4">
        <Card className="max-w-md w-full border-2 border-[#2BB6AF]/30 shadow-xl">
        ...
        <Tabs defaultValue="apply" className="space-y-6">
          ...
          <TabsContent value="apply" className="space-y-6">
              ...
              {roles.map((role) => {
                ...
                return (
                  ...
                  >
                    ...
                    <CardContent>
                      {isApproved && (
                        <Badge className="bg-[#E0F7F5] text-[#2BB6AF] mb-2">
            ...
            {selectedRole && !myRequests.some(r => r.requested_role === selectedRole && (r.status === 'pending' || r.status === 'approved')) && (
              <Card className="border-2 border-[#2BB6AF]/30">
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    className="w-full bg-gradient-to-r from-[#2BB6AF] to-[#239a94] hover:from-[#239a94] hover:to-[#1a7a75] text-white mt-6"
