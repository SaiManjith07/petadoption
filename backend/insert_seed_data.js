/**
 * DIRECT MONGODB INSERT SCRIPT
 * 
 * Copy and paste this entire script into MongoDB shell or MongoDB Compass
 * Make sure you're connected to your database first
 * 
 * All passwords are hashed for: "password123"
 * You can login with any user using email and password "password123"
 */
...
// ============================================
// STEP 2: Insert Pets for User 1 (Priya Sharma)
// ============================================

// Pet 1: Found Golden Retriever
db.pets.insertOne({
  report_type: "found",
  status: "Listed Found",
  species: "Dog",
...
print("✓ User 1 pets inserted!");

// ============================================
// STEP 3: Insert Pets for User 2 (Rajesh Kumar)
// ============================================

// Pet 3: Lost Black Labrador
db.pets.insertOne({
  report_type: "lost",
  status: "Listed Lost",
  species: "Dog",
...
print("✓ User 2 pets inserted!");

// ============================================
// STEP 4: Insert Pets for User 3 (Anita Patel)
// ============================================

// Pet 5: Lost Siamese Cat
db.pets.insertOne({
  report_type: "lost",
  status: "Listed Lost",
  species: "Cat",
...
// Pet 6: Beagle Available for Adoption
db.pets.insertOne({
  report_type: "found",
...
print("✓ User 3 pets inserted!");
print("\n============================================");
print("✓ ALL DATA INSERTED SUCCESSFULLY!");
print("============================================");
print("\nYou can now login with:");
print("1. priya.sharma@example.com / password123");
print("2. rajesh.kumar@example.com / password123");
print("3. anita.patel@example.com / password123");
print("\nTotal: 3 users, 6 pets");
